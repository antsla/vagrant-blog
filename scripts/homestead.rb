class Homestead
    def Homestead.configure(config, settings)
        ...
        # Configure The Box
        config.vm.define settings["name"] ||= "homestead-blog"
        ...
        config.vm.provider "virtualbox" do |vb|
            vb.name = settings["name"] ||= "homestead-blog"
        ...
        ["vmware_fusion", "vmware_workstation"].each do |vmware|
            config.vm.provider vmware do |v|
                v.vmx["displayName"] = settings["name"] ||= "homestead-blog"
        ...
        config.vm.provider "parallels" do |v|
            v.name = settings["name"] ||= "homestead-blog"
